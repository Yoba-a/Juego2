<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="prub.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="txFechaNacimiento" CssClass="col-md-2 control-label">Fecha de Nacimiento</asp:Label>
            <div class="col-md-4">
                <asp:TextBox runat="server" ID="txFechaNacimiento" CssClass="form-control" TextMode="Date" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txFechaNacimiento"
                    CssClass="text-danger" ErrorMessage="El campo de Fecha de Nacimiento es obligatorio." />
            </div>
        </div>

         <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="cbpais" CssClass="col-md-2 control-label">pais</asp:Label>
            <div class="col-md-4">
                <asp:DropDownList ID="cbpais" runat="server" CssClass="form-control">
                    <asp:ListItem Value="London">London</asp:ListItem>
                    <asp:ListItem Value="Nueva York">New York</asp:ListItem>
                    <asp:ListItem Value="Singapur">Singapur</asp:ListItem>
                    <asp:ListItem Value="Guatemala">Guatemala</asp:ListItem>
                    <asp:ListItem Value="Dallas">Dallas</asp:ListItem>
                </asp:DropDownList>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="cbpais"
